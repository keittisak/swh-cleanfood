    ...
    $(function () {
        ...
        table = $dt.DataTable({
            ...
            footerCallback: function (row, data, start, end, display) {
                ...
                $(api.column(3).footer()).html(api.column(3).data().sum().toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                $(api.column(4).footer()).html(api.column(4).data().sum().toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                $(api.column(5).footer()).html(api.column(5).data().sum().toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                $(api.column(6).footer()).html(api.column(6).data().sum().toFixed(2).replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
            }
        });
