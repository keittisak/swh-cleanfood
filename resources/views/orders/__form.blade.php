                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-sm" type="text" name="course_started_at" value="{{ ($order->course_started_at)?$order->course_started_at:date('Y-m-d') }}" autocomplete="off" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="row product-list" style="">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col-6">
                                                        <h5 class="text-center">ราคา <span class="product-price">{{$detail->total_amount}}</span> บาท</h5>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-6">
    ...
    $(function(){
        ...
        productAction = {
            ...
            addProductCourse:function(element){
                ...
                var i; 
                for(i=0; i<=6;i++){
                    var day = moment(courseStartedAt).add(i,'day').format('ddd');
                    dayArray.push(day);
                }
                
                var itemByDay = [];
                $.each(items, function(index,item){
                    if(itemByDay[item.day] === undefined){
                        itemByDay[item.day] = [item];
                    }else{
                        itemByDay[item.day].push(item);
                    }
                });
                ...
                $.each(dayArray, function(index, day){
                    if(itemByDay[day] !== undefined){
                        $.each(itemByDay[day], function(index,item){
                            var list = $('.product-list')[$key];
                            ...
                            $(list).find('.product-delivered-at').val(moment(courseStartedAt).add(dayCounter,'day').format('YYYY-MM-DD'))
